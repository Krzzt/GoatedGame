...
public class PopUp : MonoBehaviour
{
    ...
    public void Setup(string ThingToSay, Color PopUpColor, int PopUpSize)
    {
        ...
        currTextMesh.fontSize = PopUpSize; //smaller text, if necessary this could be a parameter in the create later ||IT Is NOW!
